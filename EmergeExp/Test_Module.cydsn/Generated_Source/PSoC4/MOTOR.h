...
#define MOTOR_RX_ENABLED                     (1u)
#define MOTOR_TX_ENABLED                     (1u)
#define MOTOR_HD_ENABLED                     (0u)
#define MOTOR_RX_INTERRUPT_ENABLED           (0u)
...
#define MOTOR_RX_BUFFER_SIZE                 (4u)
...
#define MOTOR_INIT_RX_INTERRUPTS_MASK \
                                  (uint8)((1 << MOTOR_RX_STS_FIFO_NOTEMPTY_SHIFT) \
...
#define MOTOR_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((0 << MOTOR_TX_STS_COMPLETE_SHIFT) \
                                        | (0 << MOTOR_TX_STS_FIFO_EMPTY_SHIFT) \
