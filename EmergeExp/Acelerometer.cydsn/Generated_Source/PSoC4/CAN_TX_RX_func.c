...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgorientation
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    uint8 CAN_SendMsgorientation(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_orientation_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_orientation_CALLBACK
                    CAN_SendMsg_orientation_Callback();
                #endif /* CAN_SEND_MSG_orientation_CALLBACK */
